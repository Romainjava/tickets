                            ...
                            ->schema([
                                ...
                                Forms\Components\Select::make('status_id')
                                    ...
                                    ->options(function ($get) {
                                        return TicketStatus::where('project_id', $get('project_id'))->pluck('name', 'id')->toArray();
                                    }),
                                ...
                                Forms\Components\Repeater::make('relations')
                                    ...
                                    ->schema([
                                        Forms\Components\Select::make('relation_id')
                                            ...
                                            ->options(function ($get) {
                                                return Ticket::where('project_id', $get('../../project_id'))->pluck('name', 'id')->toArray();
                                            })
                                            ->required(),
